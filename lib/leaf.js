...
class Leaf {
	 ...
	 *
	 * @example ```js
	 * const tree = await elmara("<div>example</div>")
	 * const div = tree.selectOne("div")
	 *
	 * console.log(div.text) // => "example"
	 *
	 * div.text = "update"
	 *
	 * console.log(div.text) // => "update"
	 * ```
	 */
	set text(newText) {
		if (typeof newText !== "string")
			throw new Error(`Expected newText to be a string`)
